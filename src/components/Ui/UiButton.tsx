  ...
  return (
    <button
      ...
      className={clsx(
        ...
        {
          primary:
            "border border-gray-700 active:pt-[7px] disabled:cursor-not-allowed disabled:select-none disabled:bg-transparent disabled:text-gray-700 disabled:active:py-2",
          secondary:
